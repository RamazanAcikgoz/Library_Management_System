...
public class Student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Information Technology", "International Relationship", "Economy", "Biology", "Art Design" }));
        ...
        setSize(new java.awt.Dimension(405, 368));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String sql = "insert into Student(Student_ID,Name,Address,Course,Specialization,Year,Semester) values (?,?,?,?,?,?,?)";
        try{
